...
(function (root, factory) {
    if (typeof module !== 'undefined' && module.exports) {
        ...
        root.elliptical.binding = factory(root.elliptical.utils, root.dust);
    ...
    Binding.prototype.render = function (element, template, context, callback) {
    ...
    Binding.prototype.renderTemplate = function (template, context, callback) {
        dust.render(template, context, function (err, out) {
            if (!err) {
